...
public class VerticalTraversal {
    ...
    public static void main(String[] args) {
        ...
        traversal.traverseVertically(dsa.tree.binarytree.TreeNode.BinaryTree.getTree(),0,map);
        traversal.traverseVerticallyI(dsa.tree.binarytree.TreeNode.BinaryTree.getTree());
